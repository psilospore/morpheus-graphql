...
import Data.Morpheus.Ext.Result (Eventless2)
...
setOf :: (FromList Eventless2 map k a, KeyOf k a) => Parser a -> Parser (map k a)
...
uniqTuple :: (FromList Eventless2 map k a, KeyOf k a) => Parser a -> Parser (map k a)
uniqTuple parser =
  label "Tuple" $
    parens
